...
<body>
 ...
 <a href="userupdate.php?<?php echo $array['email']?>"><input type="button" value="Update Profile"></a><br>
 <a href="userchart.php?<?php echo $array['email']?>"><input type="button" value="See User Chart"></a><br>
